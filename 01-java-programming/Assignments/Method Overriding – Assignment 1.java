class Faculty {
    ...
    // Must return double, but we have to do the math using this exact
    // one-liner so our float-precision errors perfectly match the platform's backend
    public double calculateSalary() {
        return this.basicSalary * (1 + (this.bonusPercentage / 100) + (this.carAllowancePercentage / 100));
    }
